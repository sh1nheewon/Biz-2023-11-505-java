...
public class ScoreA {
	public static void main(String[] args) {
		...
		// ScoreService 클래스를 사용하여 철수성적, 영희성적, 민수성적 이라는 객체를 선언했다. 일종의 변수를 선언한 것.
		// 각각의 객체를 생성자(new) method 를 사용하여 초기화하였다. 
		// 이 코드가 실행되면 철수성적, 영희성적, 민수성적 객체는 인스턴스 화 되었다.
